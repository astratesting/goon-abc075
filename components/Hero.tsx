      ...
      <div className="relative section-container py-20 md:py-28 lg:py-32">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="mt-6 text-lg md:text-xl text-gray-500 max-w-2xl mx-auto leading-relaxed">
            A premium spa and salon built exclusively for gay men.
            Grooming, skincare, and self-care in a space designed for you.
          </p>
            ...
            <div className="rounded-2xl bg-white/80 backdrop-blur-sm border border-sky-100 shadow-xl p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div className="flex-1">
                  <p className="text-sm font-medium text-gray-900">Now Booking</p>
                  <p className="text-xs text-gray-400">Early access members first</p>
                </div>
                <span className="text-xs px-2 py-0.5 rounded-full bg-mint-brand/20 text-emerald-700">Soon</span>
              </div>
              <div className="h-2 rounded-full bg-gray-100 overflow-hidden">
                <div className="h-full w-3/4 rounded-full bg-gradient-to-r from-sky-brand to-mint-brand" />
              </div>
              <p className="mt-3 text-xs text-gray-400 text-center">Construction in progress &mdash; opening soon</p>
            </div>
          </div>
        </div>
      </div>
